...
namespace CollegePick10V2.Migrations
{
    ...
    [Migration("20220714224931_RemoveKeys")]
            ...
            modelBuilder.Entity("CollegePick10V2.Entities.CurrentWeek", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GameID = 1,
                            FavoriteID = 1,
                            GameTime = new DateTime(2022, 7, 14, 17, 49, 31, 314, DateTimeKind.Local).AddTicks(3691),
                            HomeTeam = 1,
                            Locked = false,
                            OverUnder = 45.5m,
                            PointSpread = 21.5m,
                        ...
                        new
                        {
                            GameID = 2,
                            FavoriteID = 2,
                            GameTime = new DateTime(2022, 7, 14, 17, 49, 31, 320, DateTimeKind.Local).AddTicks(6088),
                            HomeTeam = 2,
                            Locked = false,
                            OverUnder = 52m,
                            PointSpread = 23m,
