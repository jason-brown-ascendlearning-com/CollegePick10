...
namespace CollegePick10V2.Migrations
{
    ...
    [Migration("20220714225113_AddBackKeys")]
    partial class AddBackKeys
    {
            ...
            modelBuilder.Entity("CollegePick10V2.Entities.CurrentWeek", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GameID = 1,
                            FavoriteID = 1,
                            GameTime = new DateTime(2022, 7, 14, 17, 51, 12, 803, DateTimeKind.Local).AddTicks(7138),
                            HomeTeam = 1,
                            Locked = false,
                            OverUnder = 45.5m,
                            PointSpread = 21.5m,
                        ...
                        new
                        {
                            GameID = 2,
                            FavoriteID = 2,
                            GameTime = new DateTime(2022, 7, 14, 17, 51, 12, 809, DateTimeKind.Local).AddTicks(4107),
                            HomeTeam = 2,
                            Locked = false,
                            OverUnder = 52m,
                            PointSpread = 23m,
