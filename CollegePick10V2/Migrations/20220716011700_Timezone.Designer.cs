...
namespace CollegePick10V2.Migrations
{
    ...
    [Migration("20220716011700_Timezone")]
            ...
            modelBuilder.Entity("CollegePick10V2.Entities.CurrentWeek", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GameID = 1,
                            FavoriteID = 1,
                            GameTime = new DateTime(2022, 7, 15, 20, 17, 0, 397, DateTimeKind.Local).AddTicks(2524),
                            HomeTeam = 1,
                            Locked = false,
                            OverUnder = 45.5m,
                            PointSpread = 21.5m,
                        ...
                        new
                        {
                            GameID = 2,
                            FavoriteID = 2,
                            GameTime = new DateTime(2022, 7, 15, 20, 17, 0, 403, DateTimeKind.Local).AddTicks(5764),
                            HomeTeam = 2,
                            Locked = false,
                            OverUnder = 52m,
                            PointSpread = 23m,
