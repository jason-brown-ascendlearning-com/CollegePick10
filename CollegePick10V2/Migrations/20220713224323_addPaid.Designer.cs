...
namespace CollegePick10V2.Migrations
{
    ...
    [Migration("20220713224323_addPaid")]
            ...
            modelBuilder.Entity("CollegePick10V2.Entities.CurrentWeek", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GameID = 1,
                            FavoriteID = 1,
                            GameTime = new DateTime(2022, 7, 13, 17, 43, 23, 188, DateTimeKind.Local).AddTicks(6647),
                            HomeTeam = 1,
                            Locked = false,
                            OverUnder = 45.5m,
                            PointSpread = 21.5m,
                        ...
                        new
                        {
                            GameID = 2,
                            FavoriteID = 2,
                            GameTime = new DateTime(2022, 7, 13, 17, 43, 23, 193, DateTimeKind.Local).AddTicks(9913),
                            HomeTeam = 2,
                            Locked = false,
                            OverUnder = 52m,
                            PointSpread = 23m,
