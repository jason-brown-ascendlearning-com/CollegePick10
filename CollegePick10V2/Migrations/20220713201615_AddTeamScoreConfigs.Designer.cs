...
namespace CollegePick10V2.Migrations
{
    ...
    [Migration("20220713201615_AddTeamScoreConfigs")]
    partial class AddTeamScoreConfigs
    {
            ...
            modelBuilder.Entity("CollegePick10V2.Entities.CurrentWeek", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GameID = 1,
                            FavoriteID = 1,
                            GameTime = new DateTime(2022, 7, 13, 15, 16, 15, 123, DateTimeKind.Local).AddTicks(8456),
                            HomeTeam = 1,
                            Locked = false,
                            OverUnder = 45.5m,
                            PointSpread = 21.5m,
                        ...
                        new
                        {
                            GameID = 2,
                            FavoriteID = 2,
                            GameTime = new DateTime(2022, 7, 13, 15, 16, 15, 129, DateTimeKind.Local).AddTicks(8557),
                            HomeTeam = 2,
                            Locked = false,
                            OverUnder = 52m,
                            PointSpread = 23m,
